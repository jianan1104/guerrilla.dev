...
Modify the protocol to your device what connection method you want to use. 
...
```
> For more detail about the config, please refer to [Configuration](/docs/guide/configuration).
